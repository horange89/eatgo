...
class RestaurantControllerTest {
    ...
    public void list() throws Exception {
        ...
        restaurant.add(new Restaurant().builder()
                .id(1004L).categoryId(1L).name("JOKER House").address("Seoul").build());
    ...
    public void detailWithExisted() throws Exception {
        Restaurant restaurant = new Restaurant().builder().id(1004L).name("JOKER House").address("Seoul").build();
    ...
    public void createWithValidData() throws Exception {
        given(restaurantService.addRestaurant(any())).will(invocation -> {
            ...
            return new Restaurant().builder()
                    .id(1234L).categoryId(1L).name(restaurant.getName()).address(restaurant.getAddress()).build();
        });
